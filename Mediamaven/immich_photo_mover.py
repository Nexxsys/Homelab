...
Moves photos from Immich's admin structure to organized Photos directory
...
def move_photos(source_base, destination_base, dry_run=False):
    """
    Move photos from Immich admin structure to organized Photos directory
    
    Args:
        source_base: Base path like /usr/src/app/upload/library/admin
        destination_base: Base path like /media/Photos
...
def main():
    parser = argparse.ArgumentParser(description='Move Immich photos to organized directory structure')
    ...
    parser.add_argument('--destination',
                       default='/media3/Photos/uploads', 
                       help='Destination directory (default: /media3/Photos/uploads)')
    ...
    if len(sys.argv) == 1:
        ...
        args = argparse.Namespace(
            ...
            destination='/media3/Photos/uploads', 
            dry_run=True,
            execute=False,
            cleanup_empty=False
        )
    ...
    move_photos(args.source, args.destination, dry_run)
